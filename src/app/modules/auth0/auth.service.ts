...
export class Auth {
  ...
  lock = new Auth0Lock(
    'yvcmke0uOoc2HYv0L2LYWijpGi0K1LlU',
    'makermedia.auth0.com',
    {
      ...
      additionalSignUpFields: [
        ...
        },
        {
          ...
          prefill: 'true',
          placeholder:
            "Enter your birthday. (We won't publish it but some services require a minimum age.)",
        },
        {
          type: 'select',
          name: 'Month',
  ...
  public handleAuthentication(): void {
    ...
    this.lock.on('authorization_error', err => {
      if (err.error == 'unauthorized') {
        ...
        this.notificationBarService.create({
          message:
            "Only Makers 13 years and older can register. Please come back when you're a teenager.",
...
// import { UserService,MainService } from 'app/CORE/d7services';
// import { ProfilePictureService } from 'app/modules/shared/profile-picture/profile-picture.service';

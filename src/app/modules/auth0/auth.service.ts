...
export class Auth {
  ...
  lock = new Auth0Lock('yvcmke0uOoc2HYv0L2LYWijpGi0K1LlU', 'makermedia.auth0.com', {
    ...
    theme: {
      logo: Singleton.Settings.GetBackEndUrl() + 'sites/default/files/make-logo.png',
      displayName: "...",
      primaryColor: '#00597E'
    },
...
// import { ProfilePictureService } from '../modules/shared/profile-picture/profile-picture.service';

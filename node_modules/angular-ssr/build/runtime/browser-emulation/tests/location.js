...
describe('location', function () {
    var context;
    var parsedUri = url.parse('http://localhost/test#/');
    beforeAll(function () { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, fixtures_1.createApplicationTestContext('http://localhost/test#/')];
                case 1:
                    context = _a.sent();
                    return [2 /*return*/];
            }
    ...
    it('is defined in the context of ng application execution', function () {
    ...
    it('describes the URI from the request', function () {
        return context.run(function () { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
